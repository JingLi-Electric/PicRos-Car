...
namespace can_control
{
  ...
  FrCanControl::FrCanControl()
  {
    ...
    cmd_sub_ = nh_.subscribe<geometry_msgs::Twist>("cmd_vel", 5, &FrCanControl::CmdCallBack, this);
          ...
          for (unsigned int i = 0; i < 36; ++i)
          {
	        ...
	        for(unsigned int i = 0; i < ul_pose_.size(); ++i)
  	      {
  	          ...
  	          unsigned char d_index = i;
  						...
  						if(d_index == 0)
  						{
  						  ultra_msg.front_right = ultra_data[p_index];
  						}
  						else if(d_index == 1)
  						{
  						  ultra_msg.front_left = ultra_data[p_index];
  						}
  						else if(d_index == 2)
  						{
  						  ultra_msg.left_front = ultra_data[p_index];
  						}
  						else if(d_index == 3)
  						{
  						  ultra_msg.left_rear = ultra_data[p_index];
  						}
  						else if(d_index == 4)
  						{
  						  ultra_msg.rear_left = ultra_data[p_index];
  						}
  						else if(d_index == 5)
  						{
  						  ultra_msg.rear_right = ultra_data[p_index];
  						}
  						else if(d_index == 6)
  						{
  						  ultra_msg.right_rear = ultra_data[p_index];
  						}
  						else if(d_index == 7)
  						{
  						  ultra_msg.right_front = ultra_data[p_index];
  						}
  					}
